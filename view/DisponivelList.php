...
include "../controller/DisponivelController.php";
  ...
  if(!empty($_GET['id'])){
    $disponivel->deletar($_GET['id']);
    header("location: DisponivelList.php");
  }
  if(!empty($_POST)){
    $load = $disponivel->pesquisar($_POST);

  }else{
    $load = $disponivel->carregar();
...
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      <h4><br>Listagem de camisetas disponíveis</h4>
        <form action="DisponivelList.php" method="post">
      ...
      <div class="col-6">
          ...
          <a class="btn btn-outline-primary" href="DisponivelForm.php">
      ...
      <thead>
        ...
        foreach($load as $item){
          echo"<tr>
                ...
                <td>$item->valor</td>
                <td><a href='./DisponivelForm.php?id=$item->id'><i class='fa-solid fa-pen-to-square'></i></a></td>
                <td><a href='./DisponivelList.php?id=$item->id'
